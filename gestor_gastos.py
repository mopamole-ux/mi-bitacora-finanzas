...
with tab_bitacora:
    ...
    df_editado = st.data_editor(
        ...
        column_config={
            ...
            "Categoria": st.column_config.SelectboxColumn("Categoría", options=["Servicios", "Supermercado/Despensa", "Alimentos/Restaurantes", "Software/Suscripciones", "Otros"], required=True),
